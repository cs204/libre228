...
// Б ни чего не сказал.
знания1 = new И()
знания1.добавить(new Эквивалентность(new И(АРыцарь, АЛжец), (БЛжец)))    // Добавьте

// Задача 2
// А сказал: "Мы одинаковые."
// Б сказал: "Мы разного вида."
знания2 = new И()
знания2.добавить(new Эквивалентность(new И(АРыцарь,new  Не(АЛжец)), (БЛжец)))
знания2.добавить(new Эквивалентность(new И(new Не(АРыцарь), АЛжец), (БРыцарь)))
// Задача 3
